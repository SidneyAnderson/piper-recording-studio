...
echo "    --precision 32"
echo ""
echo "Monitor training (web UI includes live loss charts):"
echo "  Visit http://localhost:8000/train -> Statistics tab"
echo ""
echo "After training, export to ONNX (or use Step 7 in the web UI):"
...
echo "    $PROJECT_DIR/models/My_Voice.EPOCH.onnx"
echo ""
echo "  cp $TRAINING_DIR/config.json $PROJECT_DIR/models/My_Voice.EPOCH.onnx.json"
echo ""
echo "Test your voice:"
echo "  echo 'Hello world!' | piper -m $PROJECT_DIR/models/My_Voice.EPOCH.onnx --output_file test.wav"
echo ""
